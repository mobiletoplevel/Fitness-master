...
- (void)insertData{
	NSString *title = @"MyFitness 开发者Christopher Zhang, Rick Wang";
	NSString *content1 = @"Christopher Zhang今年27岁，Rick Wang 今年28岁, 现居昆明，从事iOS开发一年多，之前有三年的.Net后端开发经验，也参与过一个Android原生项目的开发，有一定的项目管理经验和项目设计经验。";
